<%@ Page Title="" Language="C#" MasterPageFile="~/M_PopUp.Master" AutoEventWireup="true" CodeBehind="empresasO.aspx.cs" Inherits="OpenHack.Web.Catalogos.empresasO" %>
                ...
                <asp:UpdatePanel ID="up_Info" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:DetailsView ID="dv_Datos" runat="server" 
                            ...
                            <Fields>
                                ...
                                <asp:TemplateField>
                                    ...
                                    <ItemTemplate>
                                        <asp:DropDownList ID="ddl_Categorias" runat="server" DataSourceID="MYSQL_Categoria" 
                                            DataTextField="nombre" DataValueField="id" AutoPostBack="True" AppendDataBoundItems="True"
                                            CssClass="form-control" SelectedValue='<%# Bind("IdCategoria") %>'>
                                        ...
                                        <asp:RequiredFieldValidator ID="rfv8" runat="server" 
                                                ...
                                                ControlToValidate="ddl_Categorias"/>
                                        <asp:SqlDataSource ID="MYSQL_Categoria" runat="server" 
                        ...
                        <asp:SqlDataSource ID="MYSQL_Detalle" runat="server" 
                            ConnectionString="<%$ ConnectionStrings:open_hackConnectionString %>" 
                            ProviderName="<%$ ConnectionStrings:open_hackConnectionString.ProviderName %>" 
                            SelectCommand="wCAT_obtEmpresasD" 
