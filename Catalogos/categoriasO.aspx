<%@ Page Title="" Language="C#" MasterPageFile="~/M_PopUp.Master" AutoEventWireup="true" CodeBehind="categoriasO.aspx.cs" Inherits="OpenHack.Web.Catalogos.categoriasO" %>
                ...
                <asp:UpdatePanel ID="up_Info" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        ...
                        <asp:SqlDataSource ID="MYSQL_Detalle" runat="server" 
                            ...
                            SelectCommand="wCAT_obtCategoriasD" 
